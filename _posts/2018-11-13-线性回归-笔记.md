...
>
>4.令 $$J(W)= \frac{1}{m} \parallely-XW \parallel^2_2$$
>
>5.可得出 $$ \mathop{\arg\max}_{W} H(w) \Leftrightarrow \mathop{\arg\min}_{W}J(W) $$

### 4.求解 $$ \mathop{\arg\min}_{W} J(W) $$ : 
- 4.1因为求 $$ \mathop{\arg\min}_{W}\frac{1}{m} \parallely-XW \parallel^2_2$$ 等价求$$\mathop{\arg\min}_{W} \frac{1}{2m}\parallel y-XW \parallel^2_2$$
