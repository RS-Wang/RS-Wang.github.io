...
- 范数球，例如$$||X||_2\leq1$$,给定任意$$X,y\in\mathbb{R}^n$$且$$||X||_2\leq1,||y||_2\leq1$$,则有$$||\theta X+(1-\theta)y||_2\leq\theta||X||_2+(1-\theta)||y||_2\leq1$$
...
- 多面体：有限个半空间和半平面的交集
$$ P=\{X|AX\leq\mathbf{b},CX=\mathbf{d}\} $$
